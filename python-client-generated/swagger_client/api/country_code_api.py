...
class CountryCodeApi(object):
    ...
    def country_codes_get(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.country_codes_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.country_codes_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def country_codes_get_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieve a list of countries.  # noqa: E501

         **Filter**  Unless further parameters are entered, the list will contain all countries.<br><br>  **Filter Options**  The number of results can be limited by using the following filters: - id - name <br>  **Operators** <br> *Filter Option: id, name*  | Operator                       | Description                                                    | |--------------------------------|----------------------------------------------------------------| | eq                             | Equal                                                          | | contains(property, substring)  | Search for Substring in property's value                       | | startswith(property, substring)| Search for Substring at the beginning of the property's value  | <br>  **Filter Combinations**  Filters can be combined using the operator \"and\".<br><br>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.country_codes_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method country_codes_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='list[CountryCode]',  # noqa: E501
