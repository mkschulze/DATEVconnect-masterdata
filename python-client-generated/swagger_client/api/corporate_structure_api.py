...
class CorporateStructureApi(object):
    ...
    def corporate_structures_get(self, **kwargs):  # noqa: E501
        """Retrieve a list of corporate structures.  # noqa: E501

         **Filter**  Unless further parameters are entered, the list will contain all corporate structures (all organizations, all establishments, all functional areas).<br><br>  **Filter Options**  The number of results can be limited  by using the following filters: - id - name - number - status - timestamp <br>  **Operators** <br> *Filter Option: name*  | Operator                       | Description                                                    | |--------------------------------|----------------------------------------------------------------| | eq                             | Equal                                                          | | contains(property, substring)  | Search for Substring in property's value                       | | startswith(property, substring)| Search for Substring at the beginning of the property's value  | <br>  *Filter Option: number, timestamp*  | Operator          | Description                 | |-------------------|-----------------------------| | eq                | Equal                       | | gt                | Greater than                | | ge                | Greater than or equal       | | lt                | Less than                   | | le                | Less than or equal          | <br>  *Filter Option: id, status*  | Operator          | Description                 | |-------------------|-----------------------------| | eq                | Equal                       | <br>  **Filter Combinations**  Filters can be combined using the operator \"and\".<br><br>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.corporate_structures_get(async_req=True)
        >>> result = thread.get()
        ...
        :return: list[CorporateStructure]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.corporate_structures_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.corporate_structures_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def corporate_structures_get_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieve a list of corporate structures.  # noqa: E501

         **Filter**  Unless further parameters are entered, the list will contain all corporate structures (all organizations, all establishments, all functional areas).<br><br>  **Filter Options**  The number of results can be limited  by using the following filters: - id - name - number - status - timestamp <br>  **Operators** <br> *Filter Option: name*  | Operator                       | Description                                                    | |--------------------------------|----------------------------------------------------------------| | eq                             | Equal                                                          | | contains(property, substring)  | Search for Substring in property's value                       | | startswith(property, substring)| Search for Substring at the beginning of the property's value  | <br>  *Filter Option: number, timestamp*  | Operator          | Description                 | |-------------------|-----------------------------| | eq                | Equal                       | | gt                | Greater than                | | ge                | Greater than or equal       | | lt                | Less than                   | | le                | Less than or equal          | <br>  *Filter Option: id, status*  | Operator          | Description                 | |-------------------|-----------------------------| | eq                | Equal                       | <br>  **Filter Combinations**  Filters can be combined using the operator \"and\".<br><br>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.corporate_structures_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method corporate_structures_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='list[CorporateStructure]',  # noqa: E501
    ...
    def corporate_structures_organization_id_establishments_establishment_id_get(self, organization_id, establishment_id, **kwargs):  # noqa: E501
        """Retrieve a specific establishment.  # noqa: E501

         Retrieving a specific establishment.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.corporate_structures_organization_id_establishments_establishment_id_get(organization_id, establishment_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str organization_id: The GUID of an organization. (required)
        :param str establishment_id: The GUID of an establishment. (required)
        :param str select: Enter relevant attributes to which the results will then be limited.      
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.corporate_structures_organization_id_establishments_establishment_id_get_with_http_info(organization_id, establishment_id, **kwargs)  # noqa: E501
        else:
            (data) = self.corporate_structures_organization_id_establishments_establishment_id_get_with_http_info(organization_id, establishment_id, **kwargs)  # noqa: E501
            return data

    def corporate_structures_organization_id_establishments_establishment_id_get_with_http_info(self, organization_id, establishment_id, **kwargs):  # noqa: E501
        """Retrieve a specific establishment.  # noqa: E501

         Retrieving a specific establishment.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.corporate_structures_organization_id_establishments_establishment_id_get_with_http_info(organization_id, establishment_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['organization_id', 'establishment_id', 'select']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method corporate_structures_organization_id_establishments_establishment_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('organization_id' not in params or
            ...
            raise ValueError("Missing the required parameter `organization_id` when calling `corporate_structures_organization_id_establishments_establishment_id_get`")  # noqa: E501
        # verify the required parameter 'establishment_id' is set
        if self.api_client.client_side_validation and ('establishment_id' not in params or
                                                       params['establishment_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `establishment_id` when calling `corporate_structures_organization_id_establishments_establishment_id_get`")  # noqa: E501
        ...
        if 'establishment_id' in params:
            path_params['establishment-id'] = params['establishment_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/corporate-structures/{organization-id}/establishments/{establishment-id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='Establishment',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def corporate_structures_organization_id_get(self, organization_id, **kwargs):  # noqa: E501
        """Retrieve a specific organization.  # noqa: E501

         Retrieving a specific organization.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.corporate_structures_organization_id_get(organization_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.corporate_structures_organization_id_get_with_http_info(organization_id, **kwargs)  # noqa: E501
        else:
            (data) = self.corporate_structures_organization_id_get_with_http_info(organization_id, **kwargs)  # noqa: E501
            return data

    def corporate_structures_organization_id_get_with_http_info(self, organization_id, **kwargs):  # noqa: E501
        """Retrieve a specific organization.  # noqa: E501

         Retrieving a specific organization.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.corporate_structures_organization_id_get_with_http_info(organization_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['organization_id', 'select']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method corporate_structures_organization_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'organization_id' is set
        if self.api_client.client_side_validation and ('organization_id' not in params or
                                                       params['organization_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `organization_id` when calling `corporate_structures_organization_id_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/corporate-structures/{organization-id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='CorporateStructure',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
