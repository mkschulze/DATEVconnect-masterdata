...
class ClientGroupType(object):
    ...
    def __init__(self, id=None, name=None, note=None, short_name=None, timestamp=None, _configuration=None):  # noqa: E501
        """ClientGroupType - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this ClientGroupType.  # noqa: E501

        GUID of a client group type – internal identifier. The ID may not be entered with POST (it is issued by the system); with PUT, however, the ID is a mandatory field.  # noqa: E501

        :return: The id of this ClientGroupType.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ClientGroupType.

        GUID of a client group type – internal identifier. The ID may not be entered with POST (it is issued by the system); with PUT, however, the ID is a mandatory field.  # noqa: E501

        :param id: The id of this ClientGroupType.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ClientGroupType.  # noqa: E501

        Name of the client group type.  # noqa: E501

        :return: The name of this ClientGroupType.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ClientGroupType.

        Name of the client group type.  # noqa: E501

        :param name: The name of this ClientGroupType.  # noqa: E501
        :type: str
        """
    ...
    @property
    def note(self):
        """Gets the note of this ClientGroupType.  # noqa: E501

        Note about a client group type.  # noqa: E501

        :return: The note of this ClientGroupType.  # noqa: E501
        :rtype: str
        """
        return self._note
    ...
    @note.setter
    def note(self, note):
        """Sets the note of this ClientGroupType.

        Note about a client group type.  # noqa: E501

        :param note: The note of this ClientGroupType.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def short_name(self):
        """Gets the short_name of this ClientGroupType.  # noqa: E501

        Short name of the client group type. The short name must be unique.  # noqa: E501

        :return: The short_name of this ClientGroupType.  # noqa: E501
        :rtype: str
        """
    ...
    def short_name(self, short_name):
        """Sets the short_name of this ClientGroupType.

        Short name of the client group type. The short name must be unique.  # noqa: E501

        :param short_name: The short_name of this ClientGroupType.  # noqa: E501
        :type: str
        """
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this ClientGroupType.  # noqa: E501

        Indicates when the client group type was last edited.   # noqa: E501

        :return: The timestamp of this ClientGroupType.  # noqa: E501
        :rtype: date
        """
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this ClientGroupType.

        Indicates when the client group type was last edited.   # noqa: E501

        :param timestamp: The timestamp of this ClientGroupType.  # noqa: E501
        :type: date
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClientGroupType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClientGroupType):
            return False
