...
class FiscalYear(object):
    ...
    @property
    def valid_from(self):
        """Gets the valid_from of this FiscalYear.  # noqa: E501


        :return: The valid_from of this FiscalYear.  # noqa: E501
        :rtype: date
        """
    ...
    def valid_from(self, valid_from):
        """Sets the valid_from of this FiscalYear.


        :param valid_from: The valid_from of this FiscalYear.  # noqa: E501
        :type: date
        """
    ...
    @property
    def value(self):
        """Gets the value of this FiscalYear.  # noqa: E501

        The fiscal year indicates the date on which the fiscal year begins and the date on which the fiscal year ends. The fiscal year entry is valid for multiple years (e.g. 01013112 --> 01/01– 12/31 ; the fiscal year begins on January 1 and ends on December 31).  # noqa: E501

        :return: The value of this FiscalYear.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this FiscalYear.

        The fiscal year indicates the date on which the fiscal year begins and the date on which the fiscal year ends. The fiscal year entry is valid for multiple years (e.g. 01013112 --> 01/01– 12/31 ; the fiscal year begins on January 1 and ends on December 31).  # noqa: E501

        :param value: The value of this FiscalYear.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                value is not None and len(value) > 8):
            raise ValueError("Invalid value for `value`, length must be less than or equal to `8`")  # noqa: E501
        if (self._configuration.client_side_validation and
                value is not None and len(value) < 8):
            raise ValueError("Invalid value for `value`, length must be greater than or equal to `8`")  # noqa: E501
        if (self._configuration.client_side_validation and
                value is not None and not re.search(r'((((0[1-9])|(1\\d)|(2[0-9]))((0[1-9])|1[012]))|(30((0[13456789])|1[012]))|(31((0[13578])|1[02]))){2,2}', value)):  # noqa: E501
            raise ValueError(r"Invalid value for `value`, must be a follow pattern or equal to `/((((0[1-9])|(1\\d)|(2[0-9]))((0[1-9])|1[012]))|(30((0[13456789])|1[012]))|(31((0[13578])|1[02]))){2,2}/`")  # noqa: E501
