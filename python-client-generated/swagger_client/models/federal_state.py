...
class FederalState(object):
    ...
    def __init__(self, valid_from=None, value=None, _configuration=None):  # noqa: E501
        """FederalState - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def valid_from(self):
        """Gets the valid_from of this FederalState.  # noqa: E501


        :return: The valid_from of this FederalState.  # noqa: E501
        :rtype: date
        """
    ...
    def valid_from(self, valid_from):
        """Sets the valid_from of this FederalState.


        :param valid_from: The valid_from of this FederalState.  # noqa: E501
        :type: date
        """
    ...
    @property
    def value(self):
        """Gets the value of this FederalState.  # noqa: E501
        ...
        :return: The value of this FederalState.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this FederalState.

        A federal state is a subdivision of a federal country. The values depend on the national law applicable to the natural/legal person. If national_right='DE', the following values are permissible (BAY = Bayern, BBG = Brandenburg, BDW = Baden-Württemberg, BER = Berlin, BRE = Bremen, HBG = Hamburg, HES = Hessen, MLB = Mecklenburg-Vorpommern, NRS = Niedersachsen, NRW = Nordrhein-Westfalen, RLP = Rheinland-Pfalz, SAA = Sachsen-Anhalt, SAC = Sachsen, SAR = Saarland, SWH = Schleswig-Holstein, THG = Thüringen). If national_right='AT', the following values are permissible (BGL = Burgenland, KTN = Kärnten, NOE = Niederösterreich, OOE = Oberösterreich, SBG = Salzburg, STM = Steiermark, TIR = Tirol, VBG = Vorarlberg, W = Wien).  # noqa: E501

        :param value: The value of this FederalState.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                value is not None and len(value) > 3):
            raise ValueError("Invalid value for `value`, length must be less than or equal to `3`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FederalState, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FederalState):
            return False
