...
class LegalFormId(object):
    ...
    def __init__(self, valid_from=None, value=None, _configuration=None):  # noqa: E501
        """LegalFormId - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def valid_from(self):
        """Gets the valid_from of this LegalFormId.  # noqa: E501


        :return: The valid_from of this LegalFormId.  # noqa: E501
        :rtype: date
        """
    ...
    def valid_from(self, valid_from):
        """Sets the valid_from of this LegalFormId.


        :param valid_from: The valid_from of this LegalFormId.  # noqa: E501
        :type: date
        """
    ...
    @property
    def value(self):
        """Gets the value of this LegalFormId.  # noqa: E501

        Internal identifier of the corresponding legal form.  # noqa: E501

        :return: The value of this LegalFormId.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this LegalFormId.

        Internal identifier of the corresponding legal form.  # noqa: E501

        :param value: The value of this LegalFormId.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                value is not None and len(value) > 6):
            raise ValueError("Invalid value for `value`, length must be less than or equal to `6`")  # noqa: E501
        if (self._configuration.client_side_validation and
                value is not None and len(value) < 6):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LegalFormId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LegalFormId):
            return False
