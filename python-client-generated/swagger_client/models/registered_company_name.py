...
class RegisteredCompanyName(object):
    ...
    def __init__(self, valid_from=None, value=None, _configuration=None):  # noqa: E501
        """RegisteredCompanyName - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def valid_from(self):
        """Gets the valid_from of this RegisteredCompanyName.  # noqa: E501


        :return: The valid_from of this RegisteredCompanyName.  # noqa: E501
        :rtype: date
        """
    ...
    def valid_from(self, valid_from):
        """Sets the valid_from of this RegisteredCompanyName.


        :param valid_from: The valid_from of this RegisteredCompanyName.  # noqa: E501
        :type: date
        """
    ...
    @property
    def value(self):
        """Gets the value of this RegisteredCompanyName.  # noqa: E501

        Name of the company as it is registered with the register court.  # noqa: E501

        :return: The value of this RegisteredCompanyName.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this RegisteredCompanyName.

        Name of the company as it is registered with the register court.  # noqa: E501

        :param value: The value of this RegisteredCompanyName.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                value is not None and len(value) > 400):
            raise ValueError("Invalid value for `value`, length must be less than or equal to `400`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RegisteredCompanyName, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RegisteredCompanyName):
            return False
