...
class Consideration(object):
    ...
    def __init__(self, valid_from=None, value=None, _configuration=None):  # noqa: E501
        """Consideration - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def valid_from(self):
        """Gets the valid_from of this Consideration.  # noqa: E501


        :return: The valid_from of this Consideration.  # noqa: E501
        :rtype: date
        """
    ...
    def valid_from(self, valid_from):
        """Sets the valid_from of this Consideration.


        :param valid_from: The valid_from of this Consideration.  # noqa: E501
        :type: date
        """
    ...
    @property
    def value(self):
        """Gets the value of this Consideration.  # noqa: E501

        Indicates the reason why a child aged over 18 is included on their parents’ income tax return. This entry is only relevant to natural persons who are children of another addressee (parent). The following values are permissible (ARBEITSU = Arbeit suchend, AUSBILDG = Schul-/Berufsausbildung, BEHINDERG = Wegen Behinderung außerstande, sich selbst zu unterhalten, FEHLAUSB = Fehlender Ausbildungsplatz, FREIDST = Freiwilligendienst - kein Zivildienst, FREIWEHR = Freiwilliger Wehrdienst, GRDDST = Gesetzlicher Grundwehr-/Zivildienst oder davon befreiender Dienst, UEBERGANG = Übergangszeit von höchstens vier Monaten).  # noqa: E501

        :return: The value of this Consideration.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this Consideration.

        Indicates the reason why a child aged over 18 is included on their parents’ income tax return. This entry is only relevant to natural persons who are children of another addressee (parent). The following values are permissible (ARBEITSU = Arbeit suchend, AUSBILDG = Schul-/Berufsausbildung, BEHINDERG = Wegen Behinderung außerstande, sich selbst zu unterhalten, FEHLAUSB = Fehlender Ausbildungsplatz, FREIDST = Freiwilligendienst - kein Zivildienst, FREIWEHR = Freiwilliger Wehrdienst, GRDDST = Gesetzlicher Grundwehr-/Zivildienst oder davon befreiender Dienst, UEBERGANG = Übergangszeit von höchstens vier Monaten).  # noqa: E501

        :param value: The value of this Consideration.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Consideration, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Consideration):
            return False
